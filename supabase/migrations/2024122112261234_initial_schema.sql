...
ALTER TABLE "retros" ADD FOREIGN KEY ("current_topic_id") REFERENCES "topics" ("id");
...
ALTER TABLE "cards" ADD FOREIGN KEY ("topic_id") REFERENCES "topics" ("id");
ALTER TABLE "cards" ADD FOREIGN KEY ("retro_column_id") REFERENCES "retro_columns" ("id");

ALTER TABLE "topics" ADD FOREIGN KEY ("retro_column_id") REFERENCES "retro_columns" ("id");

ALTER TABLE "votes" ADD FOREIGN KEY ("topic_id") REFERENCES "topics" ("id");
...
CREATE INDEX idx_retros_current_topic_id ON retros (current_topic_id);
CREATE INDEX idx_retros_public_id ON retros (public_id);
CREATE INDEX idx_topics_retro_column_id ON topics (retro_column_id);
